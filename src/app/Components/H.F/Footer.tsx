  ...
  return (
    <div className="mt-10">
      <div className="bg-[#212121] flex">
        <section className="flex flex-col items-center text-center gap-2 p-2 shadow-[0_0_4px_2px_#F2F2F2] rounded-[10px] m-2 bg-[#4A4A4A]">
          <h2 className="h2">Circuit Du Bonheur</h2>
          <p className="">123 Routes des Plaisirs, 75000 Paris, France</p>
          <a href="#">+33 1 23 45 67 89</a>
          <Link href="#">contact@cdb.com</Link>
        </section>
